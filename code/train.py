...
def get_parser():
    ...
    parser.add_argument('--train_data_dir', type=str, default='../data/toy/task2.csv')
    parser.add_argument('--validation_data_dir', type=str, default='../data/toy/task2.csv')
    parser.add_argument('--test_data_dir', type=str, default='../data/toy/task2.csv')
